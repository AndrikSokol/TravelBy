      ...
      <div className=" mb-32">
        ...
        <form className="max-w-2xl mx-auto" onSubmit={handleLoginSubmit}>
          <div className="flex border rounded-2xl my-4 py-3 px-2 gap-2">
            ...
            <input type="email" placeholder="youremail@gmail.com" value={email} onChange={(ev) => setEmail(ev.target.value)} />
          </div>
          ...
          <button className="hover:opacity-90 active:opacity-95 w-full bg-primary rounded-2xl py-2 text-white font-bold ">Login</button>
