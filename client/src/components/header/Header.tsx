  ...
  return (
    <header className="w-full  border-b p-4">
      <div className="sm:w-[85%] mx-auto flex gap-2 justify-between  w-full">
        ...
        <Link to={setAuth ? "/account/profile" : "/login"} className="flex items-center  gap-1 sm:gap-2 border border-gray-300 rounded-full py-1 sm:py-2 px-2 sm:px-4 hover:shadow transition-shadow ">
          <div>
